...
| Signal conditioning (low-level sensing) | Full-stack development & API design |
...
### 🔬 Precision Sensing System *(Engineering Project)*

Designed circuits to amplify **0–100 mV signals**, eliminating dual power supplies using innovative rail generation:

`555 timer charge pump` &nbsp;·&nbsp; `Precision diode clamping` &nbsp;·&nbsp; `Voltage divider optimisation`
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/n0aheuw)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/noahjohnson-cse/)
